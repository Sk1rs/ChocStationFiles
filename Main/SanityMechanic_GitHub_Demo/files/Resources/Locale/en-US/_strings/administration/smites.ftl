...
# Sunrise-start
admin-smite-lower-sanity-name = lower sanity tier
admin-smite-lower-sanity-description = Forces the target's sanity down one tier (towards breakdown).
admin-smite-view-sanity-name = view sanity
admin-smite-view-sanity-description = Shows the target's exact sanity value and tier in a popup only you can see.
admin-smite-restore-sanity-name = restore sanity
admin-smite-restore-sanity-description = Fully restores the target's sanity to 100% and brings them out of psychic crisis if they're in one.
admin-smite-summon-hallucination-name = summon hallucination
admin-smite-summon-hallucination-description = Spawns a hallucination for the target - a clone of the target themselves, visible only to them.
# Sunrise-end
