...
# Sunrise-start
admin-smite-lower-sanity-name = понизить стадию психики
admin-smite-lower-sanity-description = Принудительно опускает психику цели на одну стадию вниз (в сторону срыва).
admin-smite-view-sanity-name = просмотреть психику
admin-smite-view-sanity-description = Показывает точное значение психики цели и её стадию во всплывающей подсказке, видимой только вам.
admin-smite-restore-sanity-name = восстановить психику
admin-smite-restore-sanity-description = Полностью восстанавливает психику цели до 100% и выводит из психического срыва, если она в нём находится.
admin-smite-summon-hallucination-name = призвать галлюцинацию
admin-smite-summon-hallucination-description = Создаёт для цели галлюцинацию - клон самой цели, видимый только ей.
# Sunrise-end
